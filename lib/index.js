...
// 调整table表头
var ResizeableTitle = function (Iprops, ref) {
...
// 拖拽调整table
var _ResizeTable = function (props, ref) {
    ...
    var genCols = function (columns) {
        var _a;
        var tableInstanceClientWidth = (_a = ref.current) === null || _a === void 0 ? void 0 : _a.clientWidth;
        ...
        if (tableInstanceClientWidth > totalWidht) {
            ...
            var mutiledCols = re.map(function (item) {
                return __assign(__assign({}, item), { width: item.width * factor_1 * 0.98 });
            });
            return mutiledCols;
        }
        return re;
    ...
    return (React.createElement("div", { className: 'resize-table' },
        React.createElement(Table, __assign({ ref: ref, size: "small", scroll: { x: 0 } }, props, { components: components, columns: columns }))));
};
